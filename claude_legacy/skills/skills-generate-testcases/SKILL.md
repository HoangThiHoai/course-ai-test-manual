...
## Chọn kỹ thuật testing phù hợp với chức năng, ví dụ: Boundary Value Analysis, Equivalence Partitioning, State Transition Testing, Decision Table Testing, Use Case Testing, Error Guessing, Exploratory Testing, v.v.